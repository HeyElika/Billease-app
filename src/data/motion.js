  ...
  },
  {
    ...
    patterns: [
      ...
      },
      {
        id: 'card-flip',
        label: 'Card flip',
        definition: 'Turning a card over to show what is on its back.',
        notes: [
          ['Status',
           'Not in the Motion system file and not implemented in the app. Listed so the category is complete and the gap is visible.'],
          ['Likely use',
           'Revealing card number and CVV on a virtual card. That makes it security-sensitive as well as a motion question: an auto-hide timer, screenshot behavior, and whether it reveals on tap or on hold all need deciding alongside the animation.'],
        ],
      },
      {
        id: 'show-hide',
        label: 'Show and hide value',
        definition: 'Revealing a masked value in place, such as a password or an account number.',
        notes: [
          ['Status',
           'Inferred from the eye-off and show icons in the icon set. Not in the Motion system file.'],
